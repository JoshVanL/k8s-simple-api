...
import (
	...
	"github.com/joshvanl/k8s-simple-api/pkg/client/scheme"
...
// SimpleV1alpha1Client is used to interact with features provided by the simple group.
type SimpleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SimpleV1alpha1Client) Messages(namespace string) MessageInterface {
